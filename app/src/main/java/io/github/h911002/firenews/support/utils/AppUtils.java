...
public final class AppUtils {
    ...
    public final static View setClickListener(View group, int id, View.OnClickListener l) {
        View v = findViewById(group, id);
        v.setOnClickListener(l);
        return v;
    }

    public final static View findViewById(View group, int id) {
