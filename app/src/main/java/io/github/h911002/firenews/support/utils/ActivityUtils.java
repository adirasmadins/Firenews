...
import io.github.h911002.firenews.support.WebViewActivity;

import static io.github.h911002.firenews.support.utils.Utils.getContext;
...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(String packageName, String className) {
        ...
        return !(getContext().getPackageManager().resolveActivity(intent, 0) == null ||
                ...
                getContext().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
     ...
     * @param protocolURL activity类
     */
    public static void startActivity(Activity activity, String protocolURL) {

        if (URLUtil.isHttpsUrl(protocolURL) || URLUtil.isHttpsUrl(protocolURL)) {
            WebViewActivity.openURL(getContext(), "", "http://www.baidu.com");
        } else {
            Class cls = null;
            try {
                cls = Class.forName(protocolURL);
    ...
    public static void startActivity(String pkg, String cls) {
        startActivity(getContext(), null, pkg, cls, null);
    }
    ...
    public static void startActivity(Bundle extras, String pkg, String cls) {
        startActivity(getContext(), extras, pkg, cls, extras);
    }
    ...
    public static void startActivity(String pkg, String cls, Bundle options) {
        startActivity(getContext(), null, pkg, cls, options);
    }
    ...
    public static void startActivity(Bundle extras, String pkg, String cls, Bundle options) {
        startActivity(getContext(), extras, pkg, cls, options);
    }
